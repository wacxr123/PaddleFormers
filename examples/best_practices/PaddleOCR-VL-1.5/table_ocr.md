...
paddleformers-cli train examples/best_practices/PaddleOCR-VL-1.5/paddleocr-vl-v15_full_16k_table_config.yaml \
                        model_name_or_path=PaddlePaddle/PaddleOCR-VL-1.5 \
                        train_dataset_path=./complex_table/complex_table_train.jsonl \
                        eval_dataset_path=./complex_table/complex_table_val.jsonl \
                        pre_alloc_memory=39
...
```bash
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 \
paddleformers-cli train examples/best_practices/PaddleOCR-VL-1.5/paddleocr-vl-v15_lora_16k_table_config.yaml \
                        model_name_or_path=PaddlePaddle/PaddleOCR-VL-1.5 \
                        train_dataset_path=./complex_table/complex_table_train.jsonl \
                        eval_dataset_path=./complex_table/complex_table_val.jsonl \
                        pre_alloc_memory=35
