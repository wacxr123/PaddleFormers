...
@add_start_docstrings(
    """
    Processor for Qwen3OmniMoe model that handles multimodal inputs (text, images, videos, audio).
    This processor combines the functionality of tokenizers and feature extractors into a single class.
    """
)
class Qwen3OmniMoeProcessor(ProcessorMixin):
    ...
    @add_start_docstrings(
        ...
        Returns a BatchFeature object containing processed inputs.
        """
    )
    def __call__(
        self,
